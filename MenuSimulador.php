  ...
  <div class="container-fluid" style="font-size: 16px;">
    ...
    <div class="navbar-header form-group col-lg-3 col-sm-6 mb-3" style="">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <span class="icon-bar"></span>
        <span class="icon-bar"></span>
         <label>Simulador de Rutas Optimas</label>
      </button>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse"  style="background: #305973; padding-top: 15px; ">
      <ul class="nav navbar-nav">
        <li><a href=""  class="fa fa-user" aria-hidden="true"> Inicio</a></li>
        <li><a href="" class="fa fa-car" aria-hidden="true"> Mapa</a></li>
      </ul>
      <!--
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li role="separator" class="divider"></li>
            <li><a href="cosultaViaje.php">Consultar</a></li>
          </ul>
        </li>
      </ul>
      -->
      ...
      <!--
                <div class="col-sm-12">
                  ...
                  <input type="text" name="origen" id="origen" placeholder="Ciudad, Delegacion, Lugar">
                </div>  
                <div class="col-sm-7" id="fin">
                  <label  style="width: 50px;">B</label>
                  <input type="text" name="destino1" placeholder="Ciudad, Delegacion, Lugar">
                </div>  
                <div class="col-sm-7" id="fin">
                  <label style="width: 50px;">C</label>
                  <input type="text" name="destino2" placeholder="Ciudad, Delegacion, Lugar">
                </div>  
                <div class="col-sm-7" id="fin">
                  <label style="width: 50px;">D</label>
                  <input type="text" name="destino3" placeholder="Ciudad, Delegacion, Lugar">
                </div>  
                <div class="col-sm-7" id="fin">
                  <label style="width: 50px;">Destino</label>
                  <input type="text" name="destinoF" placeholder="Ciudad, Delegacion, Lugar">
                </div>  
                <div class="col-sm-4">
